...
// base class for a single form OpenGL application
  ...
  public
    constructor Create(ACaption: PChar; AWidth, AHeight: Integer; AFieldOfView, AZNear, AZFar: Single);
    procedure Execute;
...
{$IFDEF CDECL}
procedure glActiveTexture(texture: GLenum); cdecl; external OpenGL name Prefix + 'glActiveTexture';
procedure glBindTexture(target: GLenum; texture: GLuint); cdecl; external OpenGL name Prefix + 'glBindTexture';
...
procedure glCompileShader(shader: GLuint); cdecl; external OpenGL name Prefix + 'glCompileShader';
procedure glCreateShader(shaderType: GLenum); cdecl; external OpenGL name Prefix + 'glCreateShader';
...
procedure glGenTextures(n: GLsizei; textures: PGLuint); cdecl; external OpenGL name Prefix + 'glGenTexture';
procedure glGetShaderiv(shader: GLuint; pname: GLenum; params: PGLint); cdecl; external OpenGL name Prefix + 'glGetShaderiv';
...
procedure glShaderSource(shader: GLuint; count: GLsizei; &string: PPGLchar; length: GLint); cdecl; external OpenGL name Prefix + 'glShaderSource';
procedure glTexImage2D(target: GLenum; level, internalFormat: GLint; width, height: GLsizei; border: GLint; format, &type: GLenum; data: GLvoid); cdecl external OpenGL name Prefix + 'glTexImage2D';
procedure glTexParameteri(target, pname: GLenum; param: GLint); cdecl; external OpenGL name Prefix + 'glTexParameteri';
...
{$IFDEF STDCALL}
procedure glBindTexture(target: GLenum; texture: GLuint); stdcall; external OpenGL;
procedure glBlendFunc(sfactor, dfactor: GLenum); stdcall; external OpenGL;
...
procedure glDisable(cap: GLenum); stdcall; external OpenGL;
...
procedure glGenTextures(n: GLsizei; textures: PGLuint); stdcall; external OpenGL;
...
procedure glLogicOp(opcode: GLenum); stdcall; external OpenGL;
...
procedure glPolygonOffset(factor, units: GLFloat); stdcall; external OpenGL;
...
procedure glScissor (x,y: GLint; width, height: GLsizei); stdcall; external OpenGL;
procedure glTexImage2D(target: GLenum; level, internalFormat: GLint; width, height: GLsizei; border: GLint; format, &type: GLenum; data: GLvoid); stdcall; external OpenGL;
procedure glTexParameteri(target, pname: GLenum; param: GLint); stdcall; external OpenGL;
...
// wglGetProcAddress
procedure glActiveTexture(texture: GLenum); stdcall; external OpenGL delayed;

procedure glGenBuffers(n: GLsizei; buffers: PGLuint); stdcall; external OpenGL delayed;
procedure glDeleteBuffers(n: GLsizei; buffers: PGLuint); stdcall; external OpenGL delayed;
procedure glBindBuffer(target: GLenum; buffer: GLuint); stdcall; external OpenGL delayed;
procedure glBufferData(target: GLenum; size: GLsizeiptr; data: GLvoid; usage: GLenum); stdcall; external OpenGL delayed;

function glCreateProgram: GLuint; stdcall; external OpenGL delayed;
function glCreateShader(shaderType: GLenum): GLuint; stdcall; external OpenGL delayed;
procedure glShaderSource(shader: GLuint; count: GLsizei; &string: PGLchar; length: PGLint); stdcall; external OpenGL delayed;
procedure glCompileShader(shader: GLuint); stdcall; external OpenGL delayed;
procedure glGetShaderiv(shader: GLuint; pname: GLenum; params: PGLint); stdcall; external OpenGL delayed;
procedure glGetShaderInfoLog(shader: GLuint; maxLength: GLsizei; length: PGLsizei; infoLog: PGLchar); stdcall; external OpenGL delayed;
procedure glAttachShader(&program, shader: GLuint); stdcall; external OpenGL delayed;
procedure glDeleteShader(shader: GLuint); stdcall; external OpenGL delayed;
procedure glDetachShader(&program, shader: GLuint); stdcall; external OpenGL delayed;
procedure glLineWidth(value: Single); stdcall; external OpenGL delayed;
procedure glLinkProgram(&program: GLuint); stdcall; external OpenGL delayed;
procedure glGetProgramiv(&program: GLuint; pname: GLenum; params: PGLint); stdcall; external OpenGL delayed;
procedure glGetProgramInfoLog(&program: GLuint; maxLength: GLsizei; length: PGLsizei; infoLog: PGLchar); stdcall; external OpenGL delayed;
function glGetAttribLocation(&program: GLuint; name: PGLchar): GLuint; stdcall; external OpenGL delayed;
function glGetUniformLocation(&program: GLuint; name: PGLchar): GLint; stdcall; external OpenGL delayed;
procedure glUseProgram(&program: GLuint); stdcall; external OpenGL delayed;
procedure glUniform1i(location: GLuint; v0: GLint); stdcall; external OpenGL delayed;
procedure glUniform1f(location: GLuint; v0: GLfloat); stdcall; external OpenGL delayed;
procedure glUniform3f(location: GLuint; v0, v1, v2: GLfloat); stdcall; external OpenGL delayed;
procedure glUniformMatrix4fv(location: GLuint; count: GLsizei; transpose: GLboolean; value: PGLfloat); stdcall; external OpenGL delayed;

procedure glEnableVertexAttribArray(index: GLuint); stdcall; external OpenGL delayed;
procedure glVertexAttribPointer(index: GLuint; size: GLint; &type: GLenum; normalized: GLboolean; stride: GLsizei; pointer: GLvoid); stdcall; external OpenGL delayed;
procedure glDisableVertexAttribArray(index: GLuint); stdcall; external OpenGL delayed;
...
//  WriteLn(MSg);
  ...
  case Msg of
    ...
    WM_PAINT  :
    begin
      TGLContext.FromHWnd(hWnd).Repaint;
      Exit;
    end;
    WM_SIZE     : TGLContext.FromHWnd(hWnd).SetSize(LOWORD(lParam), HIWORD(lParam));
    WM_DESTROY  : PostQuitMessage(0);
    WM_MOUSEMOVE: TGLContext.FromHWnd(hWnd).OnMouseMove(LOWORD(lParam), HIWORD(lParam));
  end;
end;
{$ENDIF}
...
constructor TGLContext.Create(ACaption: PChar; AWidth, AHeight: Integer; AFieldOfView, AZNear, AZFar: Single);
{$IFDEF MSWINDOWS}
var
  WndClass: TWndClass;
{$ENDIF}
...
procedure TGLContext.OnMouseMove(x, y: Integer);
begin
end;
...
{$IFDEF MSWINDOWS}
var
  Hook: TDelayedLoadHook;

function OpenGLExHook(dliNotify: dliNotification; pdli: PDelayLoadInfo): Pointer; stdcall;
begin
  if (dliNotify = dliFailGetProcAddress) and (pdli.szDll = OpenGL) then
  begin
    Result := wglGetProcAddress(pdli.dlp.szProcName);
    if Result <> nil then
      Exit;
  end;
  Hook(dliNotify, pdli);
...
initialization
{$IFDEF MSWINDOWS}
  Hook := SetDliFailureHook2(OpenGLExHook);
{$ENDIF}
end.
